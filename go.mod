...
require (
	...
	github.com/dymensionxyz/dymension/v3 v3.2.0-rc01.0.20250907081502-6516b861ae6d
...
require (
	...
	github.com/cosmos/ibc-apps/middleware/packet-forward-middleware/v8 v8.1.0 // indirect
