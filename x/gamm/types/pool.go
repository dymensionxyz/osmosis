...
type CFMMPoolI interface {
	...
	JoinPool(ctx sdk.Context, tokensIn sdk.Coins, swapFee math.LegacyDec) (numShares math.Int, err error)
	...
	JoinPoolNoSwap(ctx sdk.Context, tokensIn sdk.Coins, swapFee math.LegacyDec) (numShares math.Int, err error)
	...
	ExitPool(ctx sdk.Context, numShares math.Int, exitFee math.LegacyDec) (exitedCoins sdk.Coins, err error)
	...
	CalcJoinPoolNoSwapShares(ctx sdk.Context, tokensIn sdk.Coins, swapFee math.LegacyDec) (numShares math.Int, newLiquidity sdk.Coins, err error)
	// CalcExitPoolCoinsFromShares returns how many coins ExitPool would return on these arguments.
	// This does not mutate the pool, or state.
	CalcExitPoolCoinsFromShares(ctx sdk.Context, numShares math.Int, exitFee math.LegacyDec) (exitedCoins sdk.Coins, err error)
	// CalcJoinPoolShares returns how many LP shares JoinPool would return on these arguments.
	// This does not mutate the pool, or state.
	CalcJoinPoolShares(ctx sdk.Context, tokensIn sdk.Coins, swapFee math.LegacyDec) (numShares math.Int, newLiquidity sdk.Coins, err error)
	...
	SwapOutAmtGivenIn(ctx sdk.Context, tokenIn sdk.Coins, tokenOutDenom string, swapFee math.LegacyDec) (tokenOut sdk.Coin, err error)
	// CalcOutAmtGivenIn returns how many coins SwapOutAmtGivenIn would return on these arguments.
	// This does not mutate the pool, or state.
	CalcOutAmtGivenIn(ctx sdk.Context, tokenIn sdk.Coins, tokenOutDenom string, swapFee math.LegacyDec) (tokenOut sdk.Coin, err error)

	// SwapInAmtGivenOut swaps exactly enough tokensIn against the pool, to get the provided tokenOut amount out of the pool.
	// Balance transfers are done in the keeper, but this method updates the internal pool state.
	SwapInAmtGivenOut(ctx sdk.Context, tokenOut sdk.Coins, tokenInDenom string, swapFee math.LegacyDec) (tokenIn sdk.Coin, err error)
	// CalcInAmtGivenOut returns how many coins SwapInAmtGivenOut would return on these arguments.
	// This does not mutate the pool, or state.
	CalcInAmtGivenOut(ctx sdk.Context, tokenOut sdk.Coins, tokenInDenom string, swapFee math.LegacyDec) (tokenIn sdk.Coin, err error)
}
...
type PoolAmountOutExtension interface {
	...
	IncreaseLiquidity(sharesOut math.Int, coinsIn sdk.Coins)
}
...
type WeightedPoolExtension interface {
	...
	GetTokenWeight(denom string) (math.Int, error)
}
