...
func CalcExitPool(ctx sdk.Context, pool types.CFMMPoolI, exitingShares math.Int, exitFee math.LegacyDec) (sdk.Coins, error) {
...
func BinarySearchSingleAssetJoin(
	...
	tokenIn sdk.Coin,
	poolWithAddedLiquidityAndShares func(newLiquidity sdk.Coin, newShares math.Int) types.CFMMPoolI,
) (numLPShares math.Int, err error) {
	// use dummy context
	ctx := sdk.Context{}
	// should be guaranteed to converge if above 256 since math.Int has 256 bits
	maxIterations := 300
	...
	estimateCoinOutGivenShares := func(sharesIn math.Int) (tokenOut math.Int, err error) {
		...
		return SwapAllCoinsToSingleAsset(poolWithUpdatedLiquidity, ctx, exitedCoins, swapToDenom, math.LegacyZeroDec())
	}
...
func SwapAllCoinsToSingleAsset(pool types.CFMMPoolI, ctx sdk.Context, inTokens sdk.Coins, swapToDenom string,
	swapFee math.LegacyDec) (math.Int, error) {
