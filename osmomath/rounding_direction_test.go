...
func TestDivIntByU64ToBigDec(t *testing.T) {
	...
	tests := map[string]testcase{
		"div by zero": {math.NewInt(5), 0, RoundUp, BigDec{}, true},
		"5/3 round up": {math.NewInt(5), 3, RoundUp,
			MustNewDecFromStr("1.666666666666666666666666666666666667"), false},
		"5/3 round down": {math.NewInt(5), 3, RoundDown,
			MustNewDecFromStr("1.666666666666666666666666666666666666"), false},
		"5/3 round banker": {math.NewInt(5), 3, RoundBankers,
			MustNewDecFromStr("1.666666666666666666666666666666666667"), false},
		"7/3 round up": {math.NewInt(7), 3, RoundUp,
			MustNewDecFromStr("2.333333333333333333333333333333333334"), false},
		"7/3 round down": {math.NewInt(7), 3, RoundDown,
	...
	addTCForAllRoundingModes("odd divided by 2", math.NewInt(5), 2, NewDecWithPrec(25, 1))
