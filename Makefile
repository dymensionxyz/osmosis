...
ifneq ($(GO_MINOR_VERSION),22)
	@echo "ERROR: Go version 1.22 is required for this version of Osmosis."
	exit 1
endif
...
proto-update-deps:
	...
	$(DOCKER) run --rm -v $(CURDIR)/proto:/workspace --workdir /workspace $(protoCosmosName) buf mod update
